...
def output():
    print("N","\t", "Mid-pt rule","\t\t","Trapz. rule","\t\t","Simpson method")
    print("10","\t", m_integ(1,4,10),"\t",t_integ(1,4,10),"\t",simp(1,4,10))
    print("20","\t", m_integ(1,4,20),"\t",t_integ(1,4,20),"\t",simp(1,4,20))
    print("30","\t", m_integ(1,4,30),"\t",t_integ(1,4,30),"\t",simp(1,4,30))
